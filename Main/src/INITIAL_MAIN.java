...
//
//        //  USERS_LOGIN GUI
//        USERS_LOGIN login = new USERS_LOGIN();
//        USERS_REGISTER register = new USERS_REGISTER();
//        USERS_FORGOTPASSWORD forgotpassword = new USERS_FORGOTPASSWORD();
//
//
//        //  USERS GUI
//        USERS_HOMEPAGE users_homepage = new USERS_HOMEPAGE();
//        USERS_PROFILE users_profile = new USERS_PROFILE();
//        USERS_BOOKS users_books = new USERS_BOOKS();
//        USERS_VIEWBOOKS users_viewBooks = new USERS_VIEWBOOKS();
//
//
//        //  ADMIN GUI
//        ADMIN_HOMEPAGE admin_homepage = new ADMIN_HOMEPAGE();
//        //  THREAD FOR ADMIN
//        Thread Admin_homepage = new Thread(new Admin());
//
//
...
//
//        /*
//            INITIAL_MAIN USERS_VIEWBOOKS Start
//         */
//
...
//
//        /*
//            INITIAL_MAIN USERS_VIEWBOOKS End
//         */
//
//        /*
//            INITIAL_MAIN Books Start
//         */
//
